...
package SML::EnumeratedList;            # ci-000445
...
SML::EnumeratedList - a numbered list

=head1 SYNOPSIS

  SML::EnumeratedList->new(id=>$id,library=>$library);

  $enum_list->get_leading_whitespace;                 # Str
  $enum_list->get_indent;                             # Int
